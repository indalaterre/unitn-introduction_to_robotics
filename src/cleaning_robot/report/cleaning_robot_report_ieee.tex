...
Fig.~\ref{fig:joint_torques} shows the joint torque requirements for all 8 DOFs during the cleaning motion. The torques remain within safe limits, with the platform joints (0-1) and shoulder/elbow joints (3-4) carrying the primary load due to their significant contribution to end-effector positioning. It's worth to notice the absence of work of joint (5-6). Their primary goal is to keep the end-effector fixed at it's position.
